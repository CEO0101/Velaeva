...
export default function Home() {
  const structuredData = [
    ...
    },
    {
      ...
      sameAs: [
        "https://www.linkedin.com/company/velaeva-ai",
        "https://x.com/ZachVivek",
        "https://www.crunchbase.com/organization/velaeva-inc",
      ],
      description:
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-10 px-6 md:flex-row md:items-end md:justify-between md:px-8">
          ...
          <div className="grid gap-4 text-sm text-foreground/64">
            ...
            <div className="flex items-center gap-4 pt-1">
              <a
                href="https://www.linkedin.com/company/velaeva-ai"
                target="_blank"
                rel="noreferrer"
                aria-label="Velaeva on LinkedIn"
              ...
              <a
                href="https://x.com/ZachVivek"
                target="_blank"
                rel="noreferrer"
                aria-label="Zach Vivek on X"
                className="transition-colors hover:text-foreground"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-hidden="true">
                  <path d={siX.path} />
