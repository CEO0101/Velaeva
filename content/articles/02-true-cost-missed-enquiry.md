...
At £3,000 per transaction, that's £27,000 per month in closed revenue versus £72,000 possible. 

**£45,000 a month sitting in a timing problem.** Not a quality problem. Not a pricing problem. A timing problem.
...
This is not a reflection of a bad business. It's a reflection of a measurement problem. You can't optimise for what you can't see.

---

## What a Single Enquiry Is Actually Worth

Here's a more granular way to think about it.
...
Now calculate the cost of losing them at the first touch. Not just the £3,000. The £3,000, times the lifetime value multiplier, times the referral probability.
...
This changes how you think about the cost of not fixing it.
...
But "first thing in the morning" for a UK business means 9 AM at the earliest. If the enquiry came in at 10 PM, that's eleven hours of silence. For an American buyer in a different time zone, it's longer. For a buyer who was comparing options at 10 PM and fell asleep before your reply arrived — you're now competing with the reply they got first.
...
The businesses I work with aren't slow. They're just staffed for business hours in a world where buyer intent doesn't respect business hours. That's not a character flaw. It's an operational gap that has a straightforward solution.

---

## The Number We Actually Optimise For

When I set up a Velaeva concierge for a new client, the metric I care about most in the first 30 days is not open rate or response rate.

It's what I call the morning warmth score — the percentage of overnight leads that wake up having already received a substantive, useful, on-brand response that moved the conversation forward.

Not a holding message. Not an auto-reply. An actual response.

For one real estate client, that number went from roughly 8% in the first week (the occasional late-night reply from the agent themselves) to over 90% in the second week of the concierge being live. The leads that came in at midnight asking about specific listings got specific answers. The leads that wanted to schedule viewings got availability options. The leads that had concerns about the process got reassurance in the tone the agency actually uses.

The agent's comment at the end of month one: *"I used to dread the overnight inbox. Now I look forward to it."*
