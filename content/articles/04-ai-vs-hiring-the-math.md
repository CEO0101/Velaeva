# AI Concierge vs. Hiring: The Maths Every Service Business Should Run Before Deciding
...
Before you add employer NI contributions (roughly 13.8% above the secondary threshold), pension contributions (minimum 3%), recruitment costs, training time, sick cover, and the management overhead of someone who needs onboarding, feedback, and supervision.
...
**Hire if your after-hours volume is very low.** If you receive three or four genuine enquiries outside hours per week, the ROI on an AI concierge — while still present — takes longer to materialise. A part-time assistant handling other daytime tasks who also monitors the evening inbox might be more practical.

**Hire if your product requires deep human judgment on every first contact.** Some businesses — specialist medical, high-stakes legal, complex financial — need a human to make calls on every interaction from the start. An AI concierge can still handle intake, qualification, and routing, but if you're uncomfortable with any AI involvement in the first touch, respect that instinct.

**Hire if you want someone in the room.** An AI concierge handles digital channels. If your business needs physical presence — someone at the front desk, someone answering a physical phone line with voice — that's a different problem.
...
This is where the comparison gets uncomfortable for the hiring argument.

A well-calibrated AI concierge maintains consistent quality at 3 AM on a Wednesday the same as 6 PM on a Thursday. It doesn't get tired. It doesn't have days where it's slightly off. It doesn't say something slightly off-brand when it's distracted. It doesn't miss a message because it was handling two others simultaneously.
...
The Velaeva concierge handles overnight enquiries, qualification, booking steps, standard questions, follow-up sequences, and CRM logging. When something genuinely needs a human — a complaint, an unusual situation, a high-value client who needs a personal touch — the concierge flags it, captures the full context, and hands off to the right person with everything they need already in front of them.

The team's morning isn't a inbox triage session. It's a brief. Here's what happened overnight. Here's what needs your attention. Here's what's already resolved.

That's not replacing humans. It's letting humans do the work that actually needs humans — while the system handles the volume that previously ate their energy and attention every morning.
...
1. How many high-intent enquiries arrive outside your staffed hours per week?
2. What's your average transaction value, and how many of those enquiries convert?
3. What would those conversion numbers look like with a 5-minute response time instead of an 8-hour wait?
4. What does that gap cost you per month, in actual revenue?

Then compare that number to £149/month.

If the maths doesn't immediately make the decision for you, the call is worth having. That's what the first conversation is for.
